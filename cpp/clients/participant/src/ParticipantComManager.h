#ifndef ParticipantComManager_H
#define ParticipantComManager_H
...
class ParticipantComManager : public QObject
{
    Q_OBJECT
public:
    explicit ParticipantComManager(bool verify_ssl=true, QObject *parent = nullptr);
...
public slots:
    ...
    void login();
    void loginWithToken(const QString &token, const QString &server_name, const bool& withWebsocket);
    void logout();
...
private:
    ...
    ParticipantWebSocketManager*   m_websocketManager;
    QString                 m_username;
    QString                 m_password;
    QString                 m_token;
    QUrl                    m_serverUrl;
